...
namespace Print
{
    ...
    {
        if ((int)settings["colors"][color][0].type() == 0 || (int)settings["colors"][color][1].type() == 0 || (int)settings["colors"][color][2].type() == 0)
            return;
    ...
    {
        if (result == _RE)
            print_result(result, exit_code);
        else if (result == _TLE_O)
